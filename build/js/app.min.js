...
/***/ "./build/js/pages/page-news.js":
/*!*************************************!*\
  !*** ./build/js/pages/page-news.js ***!
  \*************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\nvar button = $('.load_more');\nvar count = button.data('count');\n\nvar paged = 1;\n\nbutton.click(function () {\n    paged++;\n\n    $.ajax({\n        type: 'POST',\n        url: ajaxurl,\n        data: {\n            post_per_page: count,\n            paged: paged,\n            action: 'load_more_news'\n        },\n        // beforeSend: function () {\n        //     button.addClass('btn-loading');\n        // },\n        success: function (data) {\n            var result = JSON.parse(data);\n            $(\".news_items\").append(result.posts);\n\n            show_more(result.max_pages);\n            //button.removeClass('btn-loading');\n        }\n    });\n});\n\n\nfunction show_more(max_pages) {\n    if (paged < max_pages) {\n        button.fadeIn();\n    } else {\n        button.hide();\n    }\n}\n\n\n\n//# sourceURL=webpack://wp-gulp/./build/js/pages/page-news.js?");

/***/ }),

/***/ "./build/js/pages/page-products.js":
/*!*****************************************!*\
  !*** ./build/js/pages/page-products.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n$(document).ready(function () {\n    var $btns = $('.tab').click(function () {\n      if (this.id == 'all') {\n        $('#parent > a').fadeIn(300);\n      } else {\n        var $el = $(`[data-type='${this.id}']`).fadeIn(300);\n        console.log($el)\n        $('#parent > a').not($el).fadeOut(300);\n      }\n      $btns.removeClass('active');\n      $(this).addClass('active');\n    })\n  });\n\n//# sourceURL=webpack://wp-gulp/./build/js/pages/page-products.js?");

/***/ }),

/***/ "./build/js/pages/single-news.js":
/*!***************************************!*\
  !*** ./build/js/pages/single-news.js ***!
  \***************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n//qwe\nvar swiper = new Swiper(\".news-swiper\", {\n    slidesPerView: 1,\n    spaceBetween: 1,\n    grabCursor: true,\n    // slidesPerView: \"auto\",\n    centeredSlides: true,\n    scrollbar: {\n        el: \".swiper-scrollbar\",\n    },\n    navigation: {\n        nextEl: \".swiper-button-next\",\n        prevEl: \".swiper-button-prev\",\n    },\n});\n\nvar swiper = new Swiper(\".blog-more-news\", {\n    slidesPerView: 3,\n    spaceBetween: 15,\n    grabCursor: true,\n    breakpoints: {\n        320: {\n            slidesPerView: 1,\n            slidesPerGroup: 1,\n        },\n        1024: {\n            slidesPerView: 3,\n            slidesPerGroup: 1,\n            spaceBetween: 15,\n        },\n        1260: {\n            slidesPerView: 3,\n            slidesPerGroup: 1,\n            spaceBetween: 24,\n        },\n        1900: {\n            slidesPerView: 3,\n            slidesPerGroup: 1,\n            spaceBetween: 32,\n        },\n    },\n    scrollbar: {\n        el: \".swiper-scrollbar-news\",\n    },\n});\n\n//# sourceURL=webpack://wp-gulp/./build/js/pages/single-news.js?");

/***/ }),

/***/ "./build/js/pages/single-products.js":
/*!*******************************************!*\
  !*** ./build/js/pages/single-products.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\nvar swiper = new Swiper(\".popular-product\", {\n    slidesPerView: 3.5,\n    spaceBetween: 15,\n    grabCursor: true,\n    breakpoints: {\n        320: {\n            slidesPerView: 1.31,\n            slidesPerGroup: 1,\n        },\n        1024: {\n            slidesPerView: 3,\n            slidesPerGroup: 1,\n        },\n        1260: {\n            slidesPerView: 3,\n            slidesPerGroup: 1,\n            spaceBetween: 24,\n        },\n        1400: {\n            slidesPerView: 3,\n            slidesPerGroup: 1,\n            spaceBetween: 24,\n        },\n        1900: {\n            slidesPerView: 3,\n            slidesPerGroup: 1,\n            spaceBetween: 32,\n        },\n    },\n    scrollbar: {\n        el: \".swiper-scrollbar\",\n    },\n    navigation: {\n        nextEl: \".swiper-button-next\",\n        prevEl: \".swiper-button-prev\",\n    },\n});\n\n//# sourceURL=webpack://wp-gulp/./build/js/pages/single-products.js?");
...
/******/ 	__webpack_require__("./build/js/libs/swiper-bundle.min.js");
/******/ 	__webpack_require__("./build/js/pages/page-home.js");
/******/ 	__webpack_require__("./build/js/pages/page-news.js");
/******/ 	__webpack_require__("./build/js/pages/page-products.js");
/******/ 	__webpack_require__("./build/js/pages/single-news.js");
/******/ 	__webpack_require__("./build/js/pages/single-products.js");
/******/ 	__webpack_require__("./build/js/modules/functions.js");
/******/ 	__webpack_require__("./build/js/modules/hover-btn.js");
/******/ 	__webpack_require__("./build/js/modules/pop-up.js");
